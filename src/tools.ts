...
export const ALL_TOOLS: ToolDefinition[] = [CHI_SQUARE_TOOL, AB_TEST_TOOL, SAMPLE_SIZE_TOOL, PEARSON_CORRELATION_TOOL, DESCRIPTIVE_STATS_TOOL, NORMAL_DISTRIBUTION_TOOL, CONFIDENCE_INTERVAL_TOOL, ONE_WAY_ANOVA_TOOL, PERCENTILE_RANK_TOOL];
