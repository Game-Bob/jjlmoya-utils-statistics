...
const UTILITY_ASSET_ROOT = "/_utilities/statistics";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/statistics/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/statistics/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("statistics");
