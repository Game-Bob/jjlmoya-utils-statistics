...
export const content: CategoryLocaleContent = {
  slug: 'statistiques',
  title: 'Outils de Statistiques et Probabilités',
  description:
  ...
  seo: [
    ...
    },
    {
      type: 'title',
      level: 2,
      text: 'Fondamentaux de l\'analyse statistique',
    },
    {
      type: 'paragraph',
      html: 'Pour naviguer avec succès dans la mer des données, il est essentiel de comprendre les piliers sur lesquels repose l\'analyse. Il ne s\'agit pas seulement d\'appliquer des formules, mais de savoir quelle histoire nous racontent les chiffres. Une analyse bien réalisée peut révéler des inefficacités dans un processus industriel, détecter des fraudes électroniques ou même sauver des vies en identifiant l\'efficacité d\'un nouveau traitement médical.',
    },
    {
      type: 'paragraph',
      html: 'Le voyage commence par la statistique descriptive, qui se charge de résumer et d\'organiser les données pour les rendre compréhensibles. Des outils de base comme la <strong>calculatrice de moyenne, médiane et mode</strong> permettent d\'obtenir un aperçu rapide du centre de notre distribution de données. Cependant, le centre n\'est pas tout ; nous devons savoir à quel point les données s\'éloignent de ce point central, ce qui nous amène aux mesures de dispersion telles que la variance et l\'écart type.',
    },
    {
      type: 'paragraph',
      html: 'Nous ne devons pas oublier l\'importance des données qualitatives par rapport aux données quantitatives. Alors que les données quantitatives nous disent "combien", les qualitatives nous disent souvent "pourquoi". Un bon statisticien sait combiner les deux mondes, utilisant les statistiques non paramétriques lorsque les données ne suivent pas une distribution normale, garantissant que les conclusions sont valides même dans les scénarios les plus bruités et désordonnés de la réalité.',
    },
    {
      type: 'title',
      level: 2,
      text: 'Concepts clés pour la prise de décision',
    },
    {
      type: 'title',
      level: 3,
    ...
    {
      type: 'paragraph',
      html: 'Imaginez analyser les salaires d\'une petite entreprise où les dirigeants gagnent dix fois plus que les employés. La moyenne vous donnerait un chiffre confortablement élevé, mais la médiane vous montrerait le salaire réel de la majorité des travailleurs. La pensée statistique critique nous apprend à regarder au-delà du premier chiffre qui apparaît à l\'écran et à toujours questionner la provenance des données et le contexte dans lequel elles sont présentées.',
    },
    {
      type: 'paragraph',
      html: 'Il existe également d\'autres types de moyennes, comme la moyenne pondérée ou la moyenne géométrique, qui sont fondamentales dans des domaines spécifiques. Par exemple, en finance, la moyenne géométrique est cruciale pour comprendre la croissance réelle d\'un investissement au fil du temps, tandis que la moyenne pondérée est essentielle dans le secteur éducatif pour calculer les notes finales basées sur l\'importance de chaque examen ou projet.',
    },
    {
      type: 'list',
      items: [
    ...
    },
    {
      type: 'title',
      level: 3,
      text: 'Probabilité et gestion de l\'incertitude',
    },
    {
      type: 'paragraph',
      html: 'La probabilité est le pont entre le monde théorique et l\'imprévisibilité de la réalité. Elle nous aide à quantifier le risque et à nous préparer à l\'inattendu. Dans des domaines tels que l\'assurance, la gestion des risques d\'entreprise ou la météorologie, les modèles probabilistes sont le moteur qui permet la durabilité du système. Sans la loi des grands nombres, les casinos feraient faillite et les compagnies aériennes ne pourraient pas garantir la sécurité de leurs trajets.',
    },
    {
      type: 'paragraph',
      html: 'Convertir l\'incertitude en probabilité mathématique est l\'une des plus grandes conquêtes de la pensée humaine. Elle nous permet de dire, avec un degré de confiance déterminé, quelle est la probabilité qu\'un événement se produise dans certaines conditions. Cela est fondamental dans la conception d\'expériences scientifiques, où chaque variable doit être contrôlée pour garantir que les découvertes sont robustes et reproductibles. La théorie des jeux et l\'inférence bayésienne sont des extensions modernes de cette recherche pour comprendre ce qui ne s\'est pas encore produit.',
    },
    {
      type: 'paragraph',
      html: 'Dans la vie quotidienne, nous sous-estimons constamment les faibles probabilités et surestimions les élevées. Les statistiques nous ramènent sur terre, nous rappelant que ce qui semble être une "coïncidence incroyable" est souvent une certitude statistique si l\'échantillon est suffisamment grand. Comprendre les probabilités nous rend des citoyens plus libres et moins manipulables face à la peur ou à l\'espoir infondés.',
    },
    {
      type: 'tip',
